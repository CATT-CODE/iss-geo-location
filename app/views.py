...
def show_location(request):
	...
	if request.method == 'POST':
		...
		# think about putting this request calls in a helper function,
		# see below
		try:
	...
	# GET is always default request
	return render(request, 'app/base.html')

def show_people(request):
		
	# __make_request(...) * See below
	try:
...
# consider implementing a helper function request for the above requests
# def __make_request(...):

# 	try:
# 		res = requests.get(url = URL1A)
# 	except:
# 		context = {'error': "API 1A ERROR"}
